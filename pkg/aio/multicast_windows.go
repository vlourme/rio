...
func setIPv4MulticastInterface(handle syscall.Handle, ifi *net.Interface) error {
...
func setIPv4MulticastLoopback(handle syscall.Handle, v bool) error {
	return os.NewSyscallError("setsockopt", syscall.SetsockoptInt(handle, syscall.IPPROTO_IP, syscall.IP_MULTICAST_LOOP, boolint(v)))
}

func joinIPv4Group(handle syscall.Handle, ifi *net.Interface, ip net.IP) error {
...
func setIPv6MulticastInterface(handle syscall.Handle, ifi *net.Interface) error {
	var v int
	if ifi != nil {
		v = ifi.Index
	}
...
func setIPv6MulticastLoopback(handle syscall.Handle, v bool) error {
...
func joinIPv6Group(handle syscall.Handle, ifi *net.Interface, ip net.IP) error {
