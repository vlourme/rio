...
func newCQEPushTypedConsumer(ring *iouring.Ring, curve Curve) (CQEConsumer, error) {
	// exit
...
func newCQEPollTypedConsumer(ring *iouring.Ring, idleTime time.Duration, curve Curve) (CQEConsumer, error) {
	// idle
	if idleTime < 1 {
